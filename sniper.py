...
# "
#   PHPSESSID = 1icshb8cham70qt3bqgat9ipb3;
#   userid    = 170898;
#   user_key  = 9cabc1a01f1879f7c8f5cefcf9f27764b1236f3e;
#   username  = bluMyst;
#   _gat_ls   = 1;
#   _gat      = 1;
#   _ga       = GA1.2.1008608779.1434945534
# "
...
def stealth_headers(ref, is_post=False, from_js=False, etc): # {{{2
    ...
    if is_post:
        ...
        h['Origin'] = urlparse.urlunparse((ref_parsed.scheme, ref_parsed.netloc, '', '', '', ''))
...
if __name__ == '__main__': # {{{1
    ...
    # get list of dragons
    # load each one's page
    # bond with any that need it
